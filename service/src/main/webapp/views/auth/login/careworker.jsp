...
<div class="container" style="max-width: 400px;">
    <div class="card-body text-center">
        <!-- 타이틀 -->
        <h3 class="card-title mb-3" style="color: #249d57; font-weight: bold;">보호사 로그인</h3>
        ...
        <div class="mt-3 d-flex justify-content-between">
            <a href="/forgot-password/careworker" style="color: #666; text-decoration: none; font-size: 14px;">아이디/비밀번호 찾기</a>
            <a href="/signup/careworker" style="color: #666; text-decoration: none; font-size: 14px;">회원가입</a>
        </div>
